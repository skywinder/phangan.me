...
COMMENT_URL_RE = re.compile(r"https?://phangan.me/[a-zA-Z]+/.+?/#comment-([a-fA-F0-9\-]+)")
POST_URL_RE = re.compile(r"https?://phangan.me/[a-zA-Z]+/(.+?)/")
...
def get_club_user(update: Update):
    ...
    if not user:
        update.message.reply_text(
            f"😐 Привяжи <a href=\"https://phangan.me/user/me/edit/bot/\">бота</a> к профилю, братишка",
