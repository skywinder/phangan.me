...
- build **frontend**
  ...
  $ npm run build
  ```
  Above commands will create [required `webpack-stats.json`](https://github.com/skywinder/phangan.me/blob/6f1812f36b546feba2bd729ac84011e20e237136/club/settings.py#L228) file
